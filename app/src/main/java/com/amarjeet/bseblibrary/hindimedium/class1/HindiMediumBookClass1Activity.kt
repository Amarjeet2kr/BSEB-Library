package com.amarjeet.bseblibrary.hindimedium.class1
...
class HindiMediumBookClass1Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hindi_medium_book_class1)
